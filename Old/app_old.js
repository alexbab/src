...
jQuery(function($) {
	...
	var ids = ['intro', 'nos-services', 'le-studio', 'lequipe','tarifs','nous-contacter'];
	...
	$(document).ready(function() {
		...
		/*if( !/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent) ) {
	    	...
	    	var win = $(window);
	    	$('.intro').css('height',win.height());
	    	$('.nos-services').css('background','#fff url("")' )
